...
import { TripDetails, tripServices } from '@/http/trip-services'
...
export default function Trip() {
  ...
  async function getTripDetails() {
    try {
      ...
      const trip = await tripServices.getById(tripParams.id)
  ...
  async function handleConfirmAttendance() {
    try {
      ...
      await participantsServices.confirmTripByParticipantId({
