...
import { linksServices } from '@/http/links-services'
import { participantsServices } from '@/http/participants-services'
...
export function Details({ tripId }: { tripId: string }) {
  ...
  async function getTripLinks() {
    try {
      const links = await linksServices.getLinksByTripId(tripId)
  ...
  async function getTripParticipants() {
    try {
      const participants = await participantsServices.getByTripId(tripId)
