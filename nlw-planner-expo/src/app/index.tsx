import { Alert, Image, ImageBackground, Keyboard, Text, View } from 'react-native'
import React, { useEffect, useState } from 'react'
import { Input } from '@/components/input'
import { MapPinIcon, CalendarIcon, Settings2Icon, UserRoundPlusIcon, ArrowRightIcon, AtSignIcon } from 'lucide-react-native'
...
import { tripServices } from '@/http/trip-services'
...
export default function Index() {
  ...
  async function createTrip() {
    try {
      ...
      const newTrip = await tripServices.create({
        destination,
